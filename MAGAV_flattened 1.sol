...
contract MAGAVoice is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(address recipient, address initialOwner)
        public initializer
    {
        __ERC20_init("MAGAVoice", "MAGAV");
        __ERC20Permit_init("MAGAVoice");
        __Ownable_init(initialOwner);

        _mint(recipient, 470000000 * 10 ** decimals());
    }
}
